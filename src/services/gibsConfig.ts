...
export const INDICATORS: Record<string, GIBSIndicator> = {
  ...
  SNOW_COVER: {
    ...
    gibsLayerName: 'MODIS_Terra_Snow_Cover',
    serviceType: 'WMS',
    timeResolution: 'daily',
    legendURL: `${GIBS_BASE_URLS.LEGENDS}/MODIS_Terra_Snow_Cover.png`,
    preferredCRS: 'EPSG:3857',
    spatialResolution: '500m',
    description: 'Cobertura de nieve y hielo',
    docURL: 'https://worldview.earthdata.nasa.gov/?l=MODIS_Terra_Snow_Cover',
    startDate: '2000-02-24',
    format: 'image/png',
  },
};
